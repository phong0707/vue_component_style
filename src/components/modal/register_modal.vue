<template>
  <TemplateModal id="register-modal">
    <div
        ...
        >
          ...
          <Form action="#" method="post" class="space-y-4" :validation-schema="formValidate">
            <div>
              ...
              <Field
                ...
                name="email"
              />
              <ErrorMessage class="text-red-500 p-4 pe-12 text-sm" name="email" />
            </div>
            <div>
              ...
              <Field
                ...
                name="password"
              />
              <ErrorMessage class="text-red-500 p-4 pe-12 text-sm" name="password" />
            </div>
            <a
